//>>built
define("dgrid/List", ["dijit/registry","dojo/_base/array","dojo/_base/kernel", "dojo/_base/declare", "dojo/on", "dojo/aspect", "dojo/has", "./util/misc", "dojo/has!touch?./TouchScroll", "xstyle/has-class", "put-selector/put", "dojo/_base/sniff", "xstyle/css!./css/dgrid.css"], 
function(registry, arrayUtil, kernel, declare, listen, aspect, has, miscUtil, TouchScroll, hasClass, put){
	...
	return declare(TouchScroll ? [TouchScroll] : [], {
		...
		destroy: function(){
			console.log('destroying grid : ' + this.id);
			// summary:
			//		Destroys this grid
