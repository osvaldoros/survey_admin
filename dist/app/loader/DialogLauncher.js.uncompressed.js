//>>built
define("app/loader/DialogLauncher", [
	"dojo/_base/declare",
	"require",
	"dojo/on",
	...
	function(declare, require, on, ContentPane,  lang, HashManager, Dialog, StatefulModule, aspect, domStyle){
		...
		return declare("app.loader.DialogLauncher", [ContentPane, StatefulModule], {
			...
			instantiateModule:function(Module){
				...
				this.module.confirmHide = function(){
					owner._dialog.confirmHide();
				}
				...
				if(typeof this.module.childActivated != 'undefined'){
					this.module.set('repositionAfterUpdate', false);
					aspect.after(this.module, "childActivated", lang.hitch(this, "repositionDialog"));
				}

				this._instantiated = true;

				if(this.__pendingActivation == true){
					this.onActivate();
					this.__pendingActivation = false;
				}
			},
			...
			show:function(){
				if(typeof(this._dialog) == "object" && this._dialog != null){
			...
			/* fwd to instance of Saver */
			setUpdatingEntity:function(entity, entityInjected){
				if(typeof(this.module) == "object" && this.module != null){
					if(typeof(this.module.setUpdatingEntity) == "function"){
						this.module.setUpdatingEntity(entity, entityInjected);
					}
				}
			},
			...
			getUpdatingEntity:function(){
				if(typeof(this.module) == "object" && this.module != null){
					if(typeof(this.module.getUpdatingEntity) == "function"){
						return this.module.getUpdatingEntity();
					}
				}
			...
			dialogClosed:function(){
				if(this.updateHash){
					if(typeof(this.closeToState) == "string"){
						this.hashManager.setState(this.closeToState);
						this.hashManager.dropHashItemsAfterNumber(1);
					}else{
