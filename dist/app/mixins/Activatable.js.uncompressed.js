...
define("app/mixins/Activatable", [
	...
	function(declare, query, lang, HashManager, topic){
	...
	return declare([], {
			...
			currentHash:null,
			usedLoader:false,
			_updatingEntityTopicHanlder:null,
			...
			updatingEntityReady:function(){
				if(typeof(this._updatingEntityTopicHanlder) == "object" && this._updatingEntityTopicHanlder != null){
					this._updatingEntityTopicHanlder.remove();
				}
				this.activate();
			},
			...
			activate:function(){
				...
				if(typeof(this.getUpdatingEntity) == "function" && typeof(this.parentWizard) == "object" && this.parentWizard != null){
					var entity = this.getUpdatingEntity();
					if(typeof(entity) == "undefined"){
						this._updatingEntityTopicHanlder = topic.subscribe(this.parentWizard.id + "-entity-ready", lang.hitch(this, "updatingEntityReady"));
						return;
					}
				}
