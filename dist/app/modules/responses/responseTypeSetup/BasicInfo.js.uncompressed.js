//>>built
require({cache:{
'url:app/modules/responses/responseTypeSetup/templates/BasicInfo.html':"<div class=\"moduleContainer\" class=\"centerPanel\" data-dojo-type=\"dijit.layout.ContentPane\" data-dojo-props=\"region: 'center'\">\n\t\n\t<form dojoType=\"app.form.Manager\" data-dojo-attach-point=\"responseTypeBasicInfoForm\" method=\"post\">\n\t\t<table cellpadding=\"0\" cellspacing=\"2\" style=\"width: 100%;\">\n\t\t\t<tr>\n\t\t\t\t<td  label=\"true\">Name: </td>\n\t\t\t\t<td><input type=\"text\" required=\"true\" name=\"name\" data-dojo-attach-point=\"name\" observer=\"recordChange\" placeholder=\"Acme Lab Inc\" dojoType=\"dijit.form.ValidationTextBox\" missingMessage=\"Ooops!  You forgot the Lab name\" /></td>\n\t\t\t\t<td></td>\n\t\t\t</tr>\n\t\t</table>\n\t</form>\n\t\n\t\n</div>"}});
define("app/modules/responses/responseTypeSetup/BasicInfo", [
	"dojo/_base/declare",
	"dojo/on",
	"dijit/_WidgetBase", 
	...
	return declare("app.modules.responses.responseTypeSetup.BasicInfo", [WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, DCFormManager], {
			...
			startup:function(){
				...
				this.responseTypeBasicInfoForm = this.getWidget('responseTypeBasicInfoForm');
				this.responseTypeBasicInfoForm.set('storeURL', __.urls.RESPONSE_TYPE);
				this.responseTypeBasicInfoForm.set('refreshUI', lang.hitch(this, "refreshFormUI"));
				
				
				this.configureForm(this.responseTypeBasicInfoForm);
			...
			onActivate:function(){
				...
				this.viewInForm(this.getUpdatingEntity(), this.responseTypeBasicInfoForm);	
			},
