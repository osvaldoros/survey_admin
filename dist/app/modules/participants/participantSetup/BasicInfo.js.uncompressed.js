...
define("app/modules/participants/participantSetup/BasicInfo", [
	...
	return declare("app.modules.participants.participantSetup.BasicInfo", [WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, DCFormManager], {
			...
			startup:function(){
				...
				this.participantBasicInfoForm = this.getWidget('participantBasicInfoForm');
				this.participantBasicInfoForm.set('storeURL', __.urls.PARTICIPANT);
				this.participantBasicInfoForm.set('refreshUI', lang.hitch(this, "refreshFormUI"));
				
				
				this.configureForm(this.participantBasicInfoForm);
			},
			...
			onActivate:function(){
				...
				this.viewInForm(this.getUpdatingEntity(), this.participantBasicInfoForm);				
			},
