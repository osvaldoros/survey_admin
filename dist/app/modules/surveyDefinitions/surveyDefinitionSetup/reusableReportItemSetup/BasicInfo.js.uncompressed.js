//>>built
require({cache:{
'url:app/modules/surveyDefinitions/surveyDefinitionSetup/reusableReportItemSetup/templates/BasicInfo.html':"<div class=\"moduleContainer\" class=\"centerPanel\" data-dojo-type=\"dijit.layout.ContentPane\" data-dojo-props=\"region: 'center'\">\n\t\n\t<form dojoType=\"app.form.Manager\" data-dojo-attach-point=\"reusableReportItemBasicInfoForm\" method=\"post\">\n\t\t<table cellpadding=\"0\" cellspacing=\"2\" style=\"width: 100%;\">\n\t\t\t<tr>\n\t\t\t\t<td  label=\"true\">Name*: </td>\n\t\t\t\t<td><input type=\"text\" required=\"true\" name=\"name\" data-dojo-attach-point=\"nameBox\" observer=\"recordChange\" placeholder=\"Acme Lab Inc\" dojoType=\"dijit.form.ValidationTextBox\" missingMessage=\"Ooops!  You forgot the ttem name\" /></td>\n\t\t\t\t<td></td>\n\t\t\t</tr>\n\t\t</table>\n\t</form>\n\t\n</div>"}});
define("app/modules/surveyDefinitions/surveyDefinitionSetup/reusableReportItemSetup/BasicInfo", [
	"dojo/_base/declare",
	"dojo/on",
	"dijit/_WidgetBase", 
	...
	return declare("app.modules.surveyDefinitions.surveyDefinitionSetup.reusableReportItemSetup.BasicInfo", [WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, DCFormManager], {
			...
			startup:function(){
				...
				this.reusableReportItemBasicInfoForm = this.getWidget('reusableReportItemBasicInfoForm');
				this.reusableReportItemBasicInfoForm.set('storeURL', __.urls.REUSABLE_REPORT_ITEM);
				this.reusableReportItemBasicInfoForm.set('refreshUI', lang.hitch(this, "refreshFormUI"));
				
				
				this.configureForm(this.reusableReportItemBasicInfoForm);
			},
			...
			onActivate:function(){
				...
				this.viewInForm(reusableReportItem, this.reusableReportItemBasicInfoForm);	
