...
define("app/modules/programs/programSetup/BasicInfo", [
	...
	return declare("app.modules.programs.programSetup.BasicInfo", [WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, DCFormManager], {
			...
			startup:function(){
				...
				this.programBasicInfoForm = this.getWidget('programBasicInfoForm');
				this.programBasicInfoForm.set('storeURL', __.urls.PROGRAM);
				this.programBasicInfoForm.set('refreshUI', lang.hitch(this, "refreshFormUI"));
				
				
				this.configureForm(this.programBasicInfoForm);
			},
			...
			onActivate:function(){
				...
				this.viewInForm(this.getUpdatingEntity(), this.programBasicInfoForm);				
			},
