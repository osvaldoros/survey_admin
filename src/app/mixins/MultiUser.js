		...
		updateActiveUsers:function(){
			...
			if(entityid != "none"){
				...
				if(otherClientsInEntity.length > 0 ){
					...
					if(typeof(this.__activeUsersLabel) != "undefined") this.__activeUsersLabel.innerHTML = "Also here: " + userNames.join(", ");
				}else{
					this.otherUsersHere = false;
					if(typeof(this.__activeUsersLabel) != "undefined") this.__activeUsersLabel.style.display = "none";
				}
			}
