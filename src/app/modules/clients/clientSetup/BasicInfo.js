define([
	...
	return declare("app.modules.laboratories.labSetup.BasicInfo", [WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, StatefulModule, DCFormManager], {
			...
			onActivate:function(){
				...
				this.loadHashEntityInForm(this.clientBasicInfoForm);				
			},
